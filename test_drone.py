...
if __name__ == '__main__':
	...
	while(time.time()-t1 < 1):
		move.move_drone(speed=[0.1, 0.0, 0.0], orient=[0.0, 0.0, 0.0])
	...
	t1 = time.time()
	while(time.time()-t1 < 1):
		move.move_drone(speed=[0.0, 0.1, 0.0], orient=[0.0, 0.0, 0.0])
	...
	t1 = time.time()
	while(time.time()-t1 < 1):
		move.move_drone(speed=[0.0, 0.0, 0.1], orient=[0.0, 0.0, 0.0])

	t1 = time.time()
	while(time.time()-t1 < 2):
		move.move_drone(speed=[0.0, 0.0, 0.0], orient=[0.0, 0.0, 0.0])
